...
public class FavDB extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME = "NBATEAMS";
    ...
    private static String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "("
            + KEY_ID + " TEXT," + TEAM_NAME+ " TEXT,"
            + TEAM_LOGO + " TEXT," + FAVORITE_STATUS+" TEXT)";
    ...
    public void insertIntoTheDatabase(String item_title, String item_image, String id, String fav_status) {
        ...
        ContentValues cv = new ContentValues();
        cv.put(TEAM_NAME, item_title);
        cv.put(TEAM_LOGO, item_image);
        cv.put(KEY_ID, id);
